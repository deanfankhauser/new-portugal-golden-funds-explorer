...
const TrustIndicators: React.FC = () => {
  ...
  return (
    <Link to="/verification-program" className="block">
      <section className="py-8 bg-emerald-50/50 dark:bg-emerald-900/10 border-y border-border hover:bg-emerald-100/50 dark:hover:bg-emerald-900/20 transition-colors cursor-pointer">
