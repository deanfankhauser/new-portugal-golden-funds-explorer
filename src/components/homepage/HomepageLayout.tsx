      ...
      <main className="container mx-auto container-responsive-padding py-6 sm:py-8 lg:py-12 flex-1 max-w-7xl">
        ...
        <section className="mt-16 pt-8 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">Golden Visa Investment Funds</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">Fund Categories</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">Why Choose MovingTo</h2>
              <ul className="text-sm text-gray-600 space-y-2">
        ...
        <section className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What is the minimum investment for Portugal Golden Visa funds?</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">How long does the Golden Visa application process take?</h3>
              <p className="text-sm text-gray-600">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Are these funds regulated by Portuguese authorities?</h3>
              <p className="text-sm text-gray-600">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Can I compare different fund options?</h3>
              <p className="text-sm text-gray-600">
