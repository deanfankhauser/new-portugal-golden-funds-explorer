      ...
      <div className="max-w-7xl mx-auto container-responsive-padding">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {topVerifiedFunds.map((fund) => (
            <div
              key={fund.id}
              className="bg-card border-2 border-accent/20 rounded-xl p-8 shadow-lg hover:shadow-xl hover:border-accent/40 transition-all duration-300"
            >
              {/* Fund Name */}
              <div className="mb-4">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between items-center pb-3 border-b border-border">
                  <span className="text-sm text-medium-contrast">Target Yield</span>
                  <span className="text-base font-semibold text-high-contrast">
                    {formatTargetYield(fund)}
                  </span>
                </div>
              </div>
