...
const RelatedFundCard: React.FC<{ fund: Fund }> = ({ fund }) => {
  ...
  return (
    <Link 
      ...
      className="group block bg-card border border-border/40 rounded-xl p-5 lg:p-8 transition-all duration-200 hover:border-border/80 hover:shadow-lg hover:translate-y-[-2px] relative overflow-hidden"
    >
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      {sameCategoryFunds.length > 0 && (
        <section className="bg-card rounded-xl border border-border/40 p-6 lg:p-10">
