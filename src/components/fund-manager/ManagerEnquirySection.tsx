...
export const ManagerEnquirySection: React.FC<ManagerEnquirySectionProps> = ({ 
  managerName,
  companyName 
}) => {
  ...
  return (
    <Card 
      id="manager-enquiry-form" 
      className="bg-card border border-border/40 rounded-2xl shadow-sm scroll-mt-28 md:scroll-mt-24 relative"
    >
      {/* Loading Overlay */}
      {isSubmitting && (
      ...
      <CardHeader className="p-10 pb-8">
        <CardTitle className="text-[32px] font-semibold tracking-tight leading-tight mb-3">
          Get in Touch with {managerName}
        </CardTitle>
...
export default ManagerEnquirySection;
