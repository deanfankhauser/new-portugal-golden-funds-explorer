  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Fund Comparisons</h1>
            ...
            <Card key={comparison.slug} className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  <GitCompare className="w-5 h-5 mr-2 text-[#EF4444]" />
                  <span className="text-sm text-gray-600 font-medium">Fund Comparison</span>
                </div>
                ...
                <Link 
                  ...
                  className="inline-flex items-center justify-center w-full bg-[#EF4444] hover:bg-[#EF4444]/90 text-white px-4 py-2 rounded-md transition-colors duration-300 font-medium"
                >
                  Compare Funds
                </Link>
              </CardContent>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm border p-8">
          <h2 className="text-2xl font-bold mb-6">Why Compare Portugal Golden Visa Funds?</h2>
