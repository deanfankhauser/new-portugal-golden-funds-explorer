export type FundTag = 
  ...
  | '€250k-€350k (GV still requires €500k total)'
  | '€300k-€400k (GV still requires €500k total)'
  | '€350k-€500k (GV still requires €500k total)'
  | '€400k-€600k (GV still requires €500k total)'
  | '€500k+'
  | 'Low-risk'
  | 'Medium-risk'
  | 'High-risk'
