-- Create security definer RPC for bulk fund manager assignment
...
grant execute on function public.admin_assign_fund_managers(text, uuid[], jsonb, text, text) to authenticated;