...
CREATE POLICY "Security audit log is admin only" ON public.security_audit_log
FOR ALL USING (false); -- No one can access this through normal means

-- Grant permissions for system use only
GRANT SELECT ON public.security_audit_log TO postgres;