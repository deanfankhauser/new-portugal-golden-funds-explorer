-- Update admin_assign_profile_managers to avoid ambiguous user_id by referencing the unique constraint explicitly
CREATE OR REPLACE FUNCTION public.admin_assign_profile_managers(
  _profile_id UUID,
  _manager_ids UUID[],
  _permissions JSONB DEFAULT '{"can_edit_funds": false, "can_manage_team": false, "can_edit_profile": true, "can_view_analytics": true}'::jsonb,
