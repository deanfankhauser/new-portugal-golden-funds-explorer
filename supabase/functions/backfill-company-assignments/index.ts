...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!isAdmin) {
      console.error('Non-admin user attempted to run backfill-company-assignments:', user.id);
    ...
    console.log('[backfill-company-assignments] Admin access verified for user:', user.id);
